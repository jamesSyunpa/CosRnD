...
TRANSLATIONS = {
    ...
    "cancel": "취소",
        ...
        "formulation_mgt": "처방 관리", "document_sub": "문서", "property_spec": "물성치/SPEC", "report": "기능성 보고/참고 자료", "ingredient_mgt": "성분 관리", "client_mgt": "거래처 관리", "user_mgt": "회원 관리", "settings_sub": "설정",
        "coa": "COA (시험성적서)", "msds": "MSDS", "prod_standard": "제품표준서", "mfg_record": "제조관리기록서",
        "mat_inspection": "원료 입고검사", "stability_test": "안정성 시험", "compatibility_test": "용기 상용성 시험",
        ...
        "browse": "찾아보기...", "save_paths": "경로 저장",
        "db_path_warning": "* DB 저장 경로는 프로그램 재시작 시 적용됩니다.",
        "db_path_options_title": "DB 경로 설정 옵션",
        "db_path_options_prompt": "새로운 DB 경로에 대한 작업을 선택하세요:",
        "db_option_create": "새 DB 생성",
        "db_option_move": "기존 DB 이동",
        "db_option_use": "경로의 DB 사용",
        ...
        "user_tree_columns": {"id": "ID", "username": "사용자 ID", "real_name": "실명", "manager_code": "담당번호", "position": "직책", "contact": "연락처", "role": "권한", "is_admin": "관리자 여부"},
        ...
        "client_labels": {"code": "거래처코드(사업자번호)", "name": "거래처명", "name_en": "영문거래처명", "ceo": "대표자명", "manager": "담당자명", "contact": "연락처", "fax": "팩스", "email": "이메일", "zip": "우편번호", "address": "주소"},
        "client_tree_columns": {"id": "ID", "type": "유형", "code": "거래처코드", "name": "거래처명", "name_en": "영문거래처명", "ceo": "대표자명", "manager": "담당자명", "contact": "연락처", "fax": "팩스", "email": "이메일", "zip": "우편번호", "address": "주소", "active": "사용여부"},
    ...
    "help": "Help", "close": "Close", "save": "Save", "cancel": "Cancel", "new": "New", "edit": "Edit", "delete": "Delete", "reset": "Reset", "search": "Search", "import": "Import", "export": "Export",
        ...
        "formulation_mgt": "Formulation Mgt.", "document_sub": "Documents", "property_spec": "Property/SPEC", "report": "Functional Report/Reference", "ingredient_mgt": "Ingredient Mgt.", 
        "client_mgt": "Client Mgt.", "user_mgt": "User Mgt.", "settings_sub": "Settings",
        "coa": "COA", "msds": "MSDS", "prod_standard": "Product Standard", "mfg_record": "Manufacturing Record",
        ...
        "db_path_options_title": "DB Path Options",
        "db_path_options_prompt": "Choose an action for the new DB path:",
        "db_option_create": "Create New DB",
        "db_option_move": "Move Existing DB",
        "db_option_use": "Use DB at Path",
        ...
        "user_labels": {"username": "User ID", "real_name": "Real Name", "password": "Password", "manager_code": "Mng. Code", "position": "Position", "contact": "Contact", "zip_code": "Zip Code", "address": "Address"},
        "user_tree_columns": {"id": "ID", "username": "User ID", "real_name": "Real Name", "manager_code": "Mng. Code", "position": "Position", "contact": "Contact", "role": "Role", "is_admin": "Is Admin"},
        ...
        "client_labels": {"code": "Client Code(Biz No.)", "name": "Client Name", "name_en": "Client Name (EN)", "ceo": "CEO Name", "manager": "Manager Name", "contact": "Contact", "fax": "Fax", "email": "Email", "zip": "Zip Code", "address": "Address"},
        "client_tree_columns": {"id": "ID", "type": "Type", "code": "Client Code", "name": "Client Name", "name_en": "Client Name (EN)", "ceo": "CEO Name", "manager": "Manager Name", "contact": "Contact", "fax": "Fax", "email": "Email", "zip": "Zip Code", "address": "Address", "active": "Is Active"},
    ...
    "formulation_tree_columns": {"id": "ID", "revision": "Revision", "manager_code": "Mng. Code", "date": "Date", "experiment_name": "Product", "lab_no": "LAB NO.", "sample_sent": "Sample Sent", "sample_delivery_date": "Delivery Date"},
        ...
        "sample_count_updated_msg": "Sample sent count updated to {count}.",
        "formulation_not_found": "Selected formulation not found.",
        "sample_count_update_error": "Error updating sample sent count: {e}",
        "edit_sample_info_title": "Edit Sample Sending Info",
        "sent_count": "Sent Count:",
        "last_sent_date": "Last Sent Date (YYYY-MM-DD):",
        "sample_info_updated_success": "Sample sending information has been updated.",
        "invalid_number_date_format": "Please enter a valid number and date format (YYYY-MM-DD).",
        "update_error_msg": "Error during update: {ex}",
        "sample_count_edit_error": "Error editing sample sent count: {e}",
        "client_list_update_error": "Error updating client list: {e}",
        "create_quotation": "Create Quotation",
        "export_quotation": "Export Quotation",
        "delete_selected": "Delete Selected",
        "base_weight_g": "Base Weight(g):",
        ...
        "price_with_vat": "Price with VAT(10%):",
        "price_with_profit": "Price with Profit(15%):",
        "select_formulation_first": "Please select a formulation from the 'Formulation List' tab first.",
        "quotation_creation_error": "Quotation Creation Error",
        "quotation_creation_error_msg": "An error occurred while creating the quotation",
        "select_item_to_edit_ratio": "Please select an item from the list to edit its ratio.",
        "select_item_to_delete": "Please select an item to delete from the list.",
        "no_quotation_to_export": "No quotation content to export. Please run 'Create Quotation' first.",
        ...
        "reset_formulation_ref_title": "Confirm Formulation Reference Reset",
        "reset_formulation_ref_confirm": "Are you sure you want to reset the material references for all formulations?\n\nThis action does not delete the formulations themselves, but changes all linked material information to a 'No Reference' state.\nThis action cannot be undone.",
        "reset_complete": "Reset Complete",
        "reset_formulation_ref_success": "Material references for all formulations have been reset.\n({count} items affected)",
        "reset_formulation_ref_error": "Error during formulation reference reset",
        "data_update_failed": "Data update failed.",
        "comment_updated_success": "Comment has been updated.",
        "edit_comment_title": "Edit Comment",
        "enter_comment_to_edit": "Enter the content to modify:",
        "no_data_to_export": "No data to export.",
        "import_journal_confirm_msg": "Import lab journal data from an Excel file.\n\nThis will update existing data based on 'LAB NO.' and add new entries if no match is found.\n\nContinue?",
        "import_journal_success_msg": "Lab journal import complete.\n- New: {added}\n- Updated: {updated}",
        "import_error_msg": "Error during import: {e}",
        "use_date_filter": "Use Date Filter",
        "year": "Year",
        "month": "Month",
        "detailed_search": "Detailed Search:",
        "enter_search_term": "Enter search term...",
        "journal_search_fields": ["All", "Product Name", "pH", "Viscosity", "Pin", "Lab No.", "Client"],
        "journal_tree_columns": {"date": "Date", "name": "Product Name", "ph": "pH", "viscosity": "Viscosity", "gravity": "Gravity", "pin": "Pin", "lab_no": "Lab No.", "client": "Client", "sample_delivery": "Sample Delivery", "comment": "Comment"},
        "no_date": "No Date",
        "create_all_lists": "Create All Lists",
        "export_to_excel": "Export to Excel",
        "select_columns_to_display": "Select Columns",
        "complex_ingredients_for_docs": "Complex Ingredients (for Docs)",
        "single_ingredients_by_ratio": "Single Ingredients (by Ratio)",
        "ingredients_for_design": "Ingredients for Design",
        "by_raw_material": "By Raw Material",
        "summed_ingredients": "Summed Ingredients",
    "complex_ingredient_tree_columns": {"no": {"text": "NO", "width": 40, "anchor": "center", "visible": True}, "material_name": {"text": "Material Name", "width": 200, "visible": True}, "inci_name": {"text": "INCI Name", "width": 200, "visible": True}, "name_ko": {"text": "Ingredient Name (KO)", "width": 200, "visible": True}, "rm_ratio": {"text": "RM Ratio(%)", "width": 120, "anchor": "e", "visible": True}, "ing_ratio": {"text": "Ing. Ratio(%)", "width": 120, "anchor": "e", "visible": True}, "actual_wt": {"text": "Actual Wt (%)", "width": 120, "anchor": "e", "visible": True}, "cas_no": {"text": "CAS No.", "width": 120, "visible": True}, "function": {"text": "Ingredient function", "width": 150, "visible": True}, "hs_code": {"text": "HS CODE", "width": 100, "visible": False}, "origin": {"text": "Origin", "width": 100, "visible": False}, "material_name_en": {"text": "Material Name (EN)", "width": 150, "visible": False}, "supplier": {"text": "Supplier", "width": 150, "visible": False}, "remark": {"text": "Remark", "width": 100, "visible": True}},
    ...
    "total_ratio_sum": "Total Ratio(%) Sum:",
    "clipboard_copy_dev": "Clipboard copy feature is under development.",
    "single_ingredient_tree_columns": {"no": {"text": "NO", "width": 40, "anchor": "center", "visible": True}, "name_en": {"text": "INGREDIENT", "width": 250, "visible": True}, "ci_no": {"text": "C.I NO", "width": 80, "visible": False}, "total_ratio": {"text": "% (W/W)", "width": 100, "anchor": "e", "visible": True}, "cas_no": {"text": "CAS. NO", "width": 120, "visible": True}, "function": {"text": "FUNCTION", "width": 150, "visible": True}, "hs_code": {"text": "HS CODE", "width": 100, "visible": False}, "remark": {"text": "Remark", "width": 150, "visible": False}},
    "total_ratio_ww_sum": "Total Ratio (% (W/W)) Sum:",
    "korean_ingredients": "Korean Ingredients",
    "english_ingredients_inci": "English Ingredients (INCI)",
    "select_formulation_and_create_list": "Please select a formulation and run 'Create All Lists' first.",
    "no_data_to_export_create_list": "No data to export. Please run 'Create All Lists' first.",
    "single_ingredients_korean": "Single Ingredients (Korean)",
    "single_ingredients_english": "Single Ingredients (English)",
    "functional_report_title": "Functional Cosmetics Exemption Report Form",
    "export_report": "Export Report",
    "usage_default": "Apply a proper amount to the skin evenly.",
    "precautions_default": "1. If you experience any symptoms such as redness, swelling, or itchiness during usage or from exposure to direct sunlight after usage, suspend use and consult a physician.\n\n2. Do not use on wounds or other areas of skin irritation.\n\n3. Storage and handling\na. Keep out of reach of children.\nb. Keep away from direct sunlight.",
    "active_substance_default": "Example:\nTotal Ethylhexyl Triazone as 4.00g\nTotal Polysilicone-15 as 3.00g",
    "ingredients_ratio_default": "Example:\nNiacinamide: 2g\nAdenosine: 0.04g",
    ...
    "form_cleared": "The input form has been cleared.",
    "required_fields_missing": "Please fill in all required fields (Product Name, LOT, Overall Conclusion).",
    ...
    # Formulation Popup
    "formulation_popup_title": "Create/Edit Formulation",
    "formulation_details": "Formulation Details",
    "use_target_info": "Use Target Info",
    "target_sample_name": "Target Sample Name",
    "target_ph": "Target pH",
    "today": "Today:",
    "next_day": "Next Day:",
    "target_viscosity": "Target Viscosity",
    "pin_and_machine": "Pin & Machine",
    "target_client": "Target Client",
    "experiment_name": "Experiment Name",
    "experiment_date": "Experiment Date",
    "manager_name": "Manager",
    "manager_code": "Mng. Code",
    "lab_no": "LAB NO.",
    "revision": "Revision",
    "client": "Client",
    ...
    "ph": "pH",
    "viscosity": "Viscosity",
    "evaluation_and_notes": "Evaluation & Notes",
    "change_history": "Change History",
    "formulation_content": "Formulation Content",
    "total_experiment_amount_g": "Total Exp. Amount(g):",
    "to_100": "To 100",
    "formulation_item_tree_columns": {"phase": "Phase", "code": "Code", "name": "Material Name", "ratio": "Ratio(%)", "amount": "Amount(g)"},
    "total_ratio_label_short": "Total Ratio:",
    "total_amount_label_short": "Total Amount:",
    "experiment_name_required": "Experiment Name is a required field.",
    "log_added": "Added",
    "log_deleted": "Deleted",
    "log_ratio_changed": "Ratio changed",
    "log_changes_from_previous": "Changes from previous version",
    "lab_no_exists_error": "'LAB NO.' is already in use for product '{name}'.\nPlease check Manager Code, Date, and Revision.",
    "save_error": "Save Error",
    "formulation_saved_success": "Formulation information has been saved.",
    "select_material_to_add": "Please select a material to add from the list.",
    "line_break": "Line Break",
    "select_item_to_delete": "Please select an item to delete.",
    "select_material_for_to100": "Please select a material from the list to apply 'To 100'.",
    "cannot_apply_to_separator": "Cannot apply ratio to a separator line.",
    "ratio_exceeds_100_warning": "The sum of other material ratios already exceeds 100%. Setting the selected material's ratio to 0.",
    "client_details_format": "Manager: {manager} / Contact: {phone}",
    "export_data_confirm_title": "Confirm Export Data",
    "import_data_confirm_title": "Confirm Import Data",
    "date_format_error": "Date Format Error",
    "invalid_date_format_warning": "'{date}' is not a valid date format. Setting to today's date.",
    "client_error": "Client Error",
    "client_not_found_warning": "Client '{name}' from Excel not found.\nPlease select a client manually.",
    "formulation_import_success": "Successfully imported formulation information.",
    "import_formulation_confirm_msg": "Import formulation from an Excel file.\nAll current content will be lost. Continue?",
