...
TRANSLATIONS = {
    "korean": {
        ...
        "formulation_tree_columns": {"id": "ID", "revision": "차수", "manager_code": "담당번호", "date": "실험일", "lab_no": "LAB NO.", "sample_sent": "샘플발송", "sample_delivery_date": "샘플발송일"},
    ...
    "english": {
        ...
        "formulation_tree_columns": {"id": "ID", "revision": "Revision", "manager_code": "Mng. Code", "date": "Date", "lab_no": "LAB NO.", "sample_sent": "Sample Sent", "sample_delivery_date": "Delivery Date"},
