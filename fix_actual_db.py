...
# 실제로 프로그램이 사용하는 DB 경로
db_path = r"C:\Users\neon5\AppData\Roaming\CosRnD\Data\cosmetic.db"
backup_path = r"C:\Users\neon5\AppData\Roaming\CosRnD\Data\cosmetic_backup_{}.db".format(int(datetime.now().timestamp()))

print(f"실제 DB: {db_path}")
...
new_db = db_path.replace('.db', '_new.db')
